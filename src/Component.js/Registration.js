    ...
    render() {
        ...
        return (
           ...
           <input type="text" name="email" className="col-lg-2"  onChange={this.handler} required/> {errors.email.length>0 && 
            ...
            <input type="submit" value="Register" className=" btn btn-primary col-md-3 " />
            <input type="submit" value="Login" className=" btn btn-primary col-md-3" style={{marginLeft:10}} onClick={this.Logi.bind()} />
            </form>
